...
def save_progress():
	...
	with open('evaluation_ConV20dir015LR.npy', 'wb') as f:
		np.save(f, evaluation)

	losses_arr = np.array(losses)
	with open('losses_ConV20dir015LR.npy', 'wb') as f:
		np.save(f, losses_arr)
		
	torch.save(model.state_dict(), 'model_ConV20dir015LR.pt')
